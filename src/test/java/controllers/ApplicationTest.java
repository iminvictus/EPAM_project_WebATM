...
//
//    private String path = "view/index.jsp";
//
//    @Before
//    public void initTest() throws ServletException {
//        userListTest = new ArrayList<>();
//        User user1 = new User(1, "Mike", "Mayers", new BigDecimal(1000));
//        User user2 = new User(2, "Spike", "Spayers", new BigDecimal(2000));
...
//
//        when(request.getRequestDispatcher(path)).thenReturn(dispatcher);/*when we invoke getRequestDispatcher
//         Mockito returns a mocked object "dispatcher"*/

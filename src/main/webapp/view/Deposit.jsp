    ...
    <section class="u-clearfix u-image u-section-1" id="sec-682f" data-image-width="2000" data-image-height="1000">
      <div class="u-align-left u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-form u-form-1">
          <form action="/deposit?id=2" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
            <div class="u-form-group u-form-name">
              <label for="name-d860" class="u-label">Amount</label>
              <input type="text" placeholder="Deposit amount" id="name-d860" name="amount" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
            </div>
